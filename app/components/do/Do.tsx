...
const Do = () => {
  ...
  return (
     <div id="do" className="flex flex-col justify-center items-center bg-white mt-4 pb-5 gap-8">
      <h1 className="text-blue-900 font-bold text-3xl mb-4 text-center">WHAT WE DO</h1>
