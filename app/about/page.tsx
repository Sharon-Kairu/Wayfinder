...
const page = () => {
  return (
    <div id='about'>
        <div className="bg-blue-900 text-white px-6 md:px-20 py-16 flex flex-col items-center justify-center text-center rounded-2xl shadow-lg mt-8">
          <h1 className="text-3xl md:text-4xl font-bold text-orange-500 mb-6 relative inline-block">
            Who are we
          </h1 >
            ...
            INGOs and governments to design stronger, data-driven interventions in Somalia and across East Africa.
            </p>
        </div>
